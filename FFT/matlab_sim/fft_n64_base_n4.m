...
W = exp(-1i*2*pi/N);
w = W^0;
dataA11 = (dataA1(1) + dataA1(3) + dataA1(2) + dataA1(4));                               % 0  
dataA12 = (((dataA1(1) + dataA1(3)) - (dataA1(2) +  dataA1(4))).*exp(-1i*2*pi/N*(2*n)));  % 32
dataA13 = (((dataA1(1) - dataA1(3)) - 1i*(dataA1(2) -  dataA1(4))).*exp(-1i*2*pi/N*(1*n)));% 16
dataA14 = (((dataA1(1) - dataA1(3)) + 1i*(dataA1(2) -  dataA1(4))).*exp(-1i*2*pi/N*(3*n)));% 48

%fft_dataA(1:4:16) = fft(dataA1); 这里只展开一个式子，后面15个都需要像这样展开,我就偷懒不写了
